...
- 폰트
  - [갈무리](https://github.com/quiple/galmuri)
  - [물마루](https://github.com/mushsooni/mulmaru)
  - [Neo 둥근모](https://github.com/neodgm/neodgm)

## 사용법

1. [최신 Release 다운로드](https://github.com/killterm/Localization-LostWiki/releases/download/1.2/LostWikiKozlovkaPatcher.exe) 후 게임 설치 경로로 이동
2. 실행
